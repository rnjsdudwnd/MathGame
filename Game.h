#pragma once
//It seems some of you may have to make the following 
//variables static in the Game.h file to get your program to work :
//const double REWARD = 0.05;
//const double PENALTY = 0.03;
//If you have to then, make the change.
